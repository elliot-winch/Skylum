...
public class AircraftPhysics : MonoBehaviour
{
    ...
    public Topic<float> ThrustPercent { get; } = new();
    ...
    private void FixedUpdate()
    {
        ...
        Vector3 velocityPrediction = PredictVelocity(forceAndTorqueThisFrame.p
            + transform.forward * thrust * ThrustPercent.Value + Physics.gravity * rb.mass);
        ...
        rb.AddForce(transform.forward * thrust * ThrustPercent.Value);
    }
